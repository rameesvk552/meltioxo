...
export const DASHBOARD_WIDGETS = [
  ...
  { key: 'cash_collected', label: 'Revenue Flow: Cash Collected' },
  { key: 'bank_collected', label: 'Revenue Flow: Bank Collections' },
  { key: 'cash_paid', label: 'Revenue Flow: Cash Payments' },
  { key: 'bank_paid', label: 'Revenue Flow: Bank Payments' },
  { key: 'cash_balance', label: 'Revenue Flow: Cash Balance' },
  { key: 'bank_balance', label: 'Revenue Flow: Bank Balance' },
